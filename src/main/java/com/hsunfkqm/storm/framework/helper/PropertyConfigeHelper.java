package com.hsunfkqm.storm.framework.helper;
...
public class PropertyConfigeHelper {
    ...
    static {
        ...
        try {
            ...
            if (null == is) {
                throw new IllegalStateException("storm.properties can not found in the classpath.");
            }
            properties.load(is);
