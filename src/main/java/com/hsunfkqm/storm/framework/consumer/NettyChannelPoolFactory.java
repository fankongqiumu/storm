...
import com.hsunfkqm.storm.framework.helper.PropertyConfigeHelper;
import com.hsunfkqm.storm.framework.internal.StormResponse;
import com.hsunfkqm.storm.framework.internal.ProviderService;
import com.hsunfkqm.storm.framework.serialization.NettyDecoderHandler;
import com.hsunfkqm.storm.framework.serialization.NettyEncoderHandler;
            ...
            bootstrap.group(group)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        public void initChannel(SocketChannel ch) throws Exception {
                            ...
                            //注册Netty解码器
                            ch.pipeline().addLast(new NettyDecoderHandler(StormResponse.class, serializeType));
                            //注册客户端业务逻辑处理handler
